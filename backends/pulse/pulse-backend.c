...
static void
pulse_backend_class_finalize (PulseBackendClass *klass G_GNUC_UNUSED)
{
}
...
static void
on_connection_server_info (PulseConnection      *connection G_GNUC_UNUSED,
			   const pa_server_info *info,
			   PulseBackend         *pulse)
{
    CafeMixerStream *stream;
...
static void
on_connection_card_removed (PulseConnection *connection G_GNUC_UNUSED,
			    guint            index,
			    PulseBackend    *pulse)
{
    PulseDevice *device;
...
static void
on_connection_sink_removed (PulseConnection *connection G_GNUC_UNUSED,
			    guint            idx,
			    PulseBackend    *pulse)
{
    PulseStream *stream;
...
static void
on_connection_sink_input_info (PulseConnection          *connection G_GNUC_UNUSED,
			       const pa_sink_input_info *info,
			       PulseBackend             *pulse)
{
    PulseSink *sink = NULL;
...
static void
on_connection_sink_input_removed (PulseConnection *connection G_GNUC_UNUSED,
				  guint            idx,
				  PulseBackend    *pulse)
{
    PulseSink *sink;
...
static void
on_connection_source_removed (PulseConnection *connection G_GNUC_UNUSED,
			      guint            idx,
			      PulseBackend    *pulse)
{
    PulseDevice *device;
...
static void
on_connection_source_output_info (PulseConnection             *connection G_GNUC_UNUSED,
				  const pa_source_output_info *info,
				  PulseBackend                *pulse)
{
...
static void
on_connection_source_output_removed (PulseConnection *connection G_GNUC_UNUSED,
				     guint            idx,
				     PulseBackend    *pulse)
{
    PulseSource *source;
...
static void
on_connection_ext_stream_loading (PulseConnection *connection G_GNUC_UNUSED,
				  PulseBackend    *pulse)
{
    GHashTableIter iter;
    gpointer       ext;
...
static void
on_connection_ext_stream_loaded (PulseConnection *connection G_GNUC_UNUSED,
				 PulseBackend    *pulse)
{
    GHashTableIter iter;
    gpointer       name;
...
static gboolean
compare_stream_names (gpointer key G_GNUC_UNUSED,
		      gpointer value,
		      gpointer user_data)
{
